...
const UserRegistration = () => {
  ...
  return (
    ...
    <Box component='form' noValidate id='registration-form' onSubmit={handleSubmit}>
        ...
        <TextField required fullWidth margin='normal' id='password2' name='password2' label='Confirm Password' type='password'/>
        ...
        <Box textAlign='center'><Button type='submit' variant='contained' sx={{mt: 3, mb: 2, px:5}}>Sign Up</Button></Box> 
